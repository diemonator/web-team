...
if (isset($_POST['register_btn']))
{
    ...
    $_SESSION['username']= $regi_username;
...
<body>
    ...
    <ul class="topnav">
        <li style="float:left;"> <a  id="logo" style="padding:0; "href="Home.html"> <img style="height: 48px;" src="resorces/proxy.png"></a></li>
            ...
            <li style="float:right; padding: 0;"><a id="logIn" href="LonIn.html"></a></li>
            </ul>
    ...
    <div class="container">
        <div class="flat-form">
            ...
            <div id="login" class="form-action show">
                ...
                <p>
                    You can totaly log in our website try it out now. You relly can do it
                </p>
